        ...
        <main className="min-h-screen bg-cream flex">
            ...
            <div className="hidden lg:block w-[45%] relative">
                <Image
                    ...
                    priority
                />
                <div className="absolute inset-0 bg-gradient-to-r from-terracotta/20 to-black/40" />
                <div className="absolute inset-0 flex items-end p-12">
                    <div>
                        <h2 className="font-playfair text-4xl text-white font-bold leading-tight mb-4">
                            Start your creative journey today
                        </h2>
                        <p className="text-base font-inter text-white/70 max-w-sm">
                            Join thousands of creative enthusiasts discovering new skills and making
                            lasting memories.
                        </p>
                    </div>
                </div>
            ...
            <div className="flex-1 flex items-center justify-center px-6 py-12">
                ...
                >
                    ...
                    <p className="text-body text-dark-muted mb-8">
                        Join our creative community and start exploring workshops.
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <label className="flex items-start gap-3 cursor-pointer">
                            <input
                                type="checkbox"
                                required
                                className="w-4 h-4 rounded border-gray-300 accent-terracotta mt-0.5"
                            />
