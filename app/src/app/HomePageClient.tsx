                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-[360px,1fr]">
                            ...
                            <div className="p-6 sm:p-8">
                                ...
                                <p className="text-sm font-inter text-dark-muted mb-4">
                                    {formatDate(pastWorkshop.date)} &bull; {pastWorkshop.time}{" "}
                                    &bull; {pastWorkshop.location}, {pastWorkshop.city}
                                </p>
            ...
            <section className="section-padding mt-24">
                <motion.div
                    ...
                    transition={
                        prefersReducedMotion
                            ? { duration: 0 }
                            : { ...standardTransition, duration: 0.8 }
                    }
                ...
                <div className="flex w-full relative">
                    ...
                    >
                        {[
                            ...
                            {
                                name: "Cafe Peter",
                                img: "https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&q=80&w=200&h=200",
                            },
                            {
                                name: "Blue Tokai",
                                img: "https://images.unsplash.com/photo-1507133750073-1f1f2bc88eb1?auto=format&fit=crop&q=80&w=200&h=200",
                            },
                            {
                                name: "Nook Cafe",
                                img: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&q=80&w=200&h=200",
                            },
                            {
                                name: "Boka Cafe",
                                img: "https://images.unsplash.com/photo-1600093463592-8e36ae95ef56?auto=format&fit=crop&q=80&w=200&h=200",
                            },
                            {
                                name: "Third Space Cafe",
                                img: "https://images.unsplash.com/photo-1511920170033-f8396924c348?auto=format&fit=crop&q=80&w=200&h=200",
                            },
                            {
                                name: "Third Place Cafe",
                                img: "https://images.unsplash.com/photo-1453614512568-c4024d13c247?auto=format&fit=crop&q=80&w=200&h=200",
                            },
                            {
                                name: "Raaha Cafe",
                                img: "https://images.unsplash.com/photo-1525610553991-2bede1a236e2?auto=format&fit=crop&q=80&w=200&h=200",
                            },
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-lg font-inter text-white/80 max-w-lg mx-auto mb-8">
                            Are you a creative professional? Get in touch with our team and we will
                            help you set up your workshop.
                        </p>
