...
export const metadata: Metadata = {
    title: "Terms of Service | Only Workshops",
    description: "Terms that govern bookings, accounts, and use of the Only Workshops platform.",
    alternates: {
        canonical: getAbsoluteUrl("/legal/terms"),
    },
};
...
export default function TermsPage() {
    return (
        <StaticPage
            ...
            description="These terms govern your use of Only Workshops."
        >
            <section>
            ...
            <section>
                ...
                <p>
                    Only Workshops acts as a platform between hosts and attendees. Hosts are
