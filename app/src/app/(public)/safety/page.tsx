...
export const metadata: Metadata = {
    title: "Safety | Only Workshops",
    description:
        "Read the safety standards, reporting guidance, and support expectations for Only Workshops events.",
    alternates: {
        canonical: getAbsoluteUrl("/safety"),
    },
};
