...
describe("normalizeWorkshopVideoUrlInput", () => {
    ...
    it("normalizes Google Drive URLs to preview format", () => {
        ...
        testCases.forEach(url => {
            expect(normalizeWorkshopVideoUrlInput(url)).toBe("https://drive.google.com/file/d/1abc-123_XYZ/preview");
        });
    });

    it("normalizes YouTube URLs to embed format", () => {
        const testCases = [
            { input: "https://www.youtube.com/watch?v=dQw4w9WgXcQ", expected: "https://www.youtube.com/embed/dQw4w9WgXcQ" },
            { input: "https://youtube.com/watch?v=dQw4w9WgXcQ&t=10s", expected: "https://www.youtube.com/embed/dQw4w9WgXcQ" },
            { input: "https://youtu.be/dQw4w9WgXcQ", expected: "https://www.youtube.com/embed/dQw4w9WgXcQ" },
            { input: "https://www.youtube.com/shorts/dQw4w9WgXcQ", expected: "https://www.youtube.com/embed/dQw4w9WgXcQ" },
    ...
    it("returns trimmed original for other URLs or strings", () => {
        expect(normalizeWorkshopVideoUrlInput("  https://example.com/video.mp4  ")).toBe("https://example.com/video.mp4");
...
describe("normalizeWorkshopImageUrlInput", () => {
    ...
    it("normalizes Google Drive URLs to direct view format", () => {
        ...
        expect(normalizeWorkshopImageUrlInput(url)).toBe("https://drive.google.com/uc?export=view&id=1abc-123_XYZ");
    });

    it("returns trimmed original for non-Drive URLs", () => {
        expect(normalizeWorkshopImageUrlInput("  https://example.com/image.png  ")).toBe("https://example.com/image.png");
    });
});
